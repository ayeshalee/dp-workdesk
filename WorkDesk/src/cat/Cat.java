...
class Eat implements CatBehaviour
{
    @Override
        public void move()
        {
            System.out.println("I am eating burpp.");
        }
}
...
class blackCat extends CatMain
{
    public blackCat()
    {
        setCatBehaviour(new Sleep());
    }
}

class orangeCat extends CatMain
{
    public orangeCat()
    {
        setCatBehaviour(new Eat());
    }
}

class siameseCat extends CatMain
{
    siameseCat()
    {
        setCatBehaviour(new Lick());
    }
}
...
public class Cat {
    ...
    public static void main(String[] args) {
        ...
        while (true){
            ...
            System.out.println("Type 1 for Black Cat, 2 for Orange Cat, 3 for Siamese Cat, 4 to exit: ");
    ...
    static void displayAndMove(CatMain v)
    {
